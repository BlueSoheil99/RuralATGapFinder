...
class RuralActiveTransportAnalysis(object):
    ...
    def getParameterInfo(self):
        ...
        state_counties_fc = arcpy.Parameter(
            displayName="State Counties Layer",
            name="state_counties_fc",
            datatype="DEFeatureClass",
            parameterType="Required",
            direction="Input"
        )

        # Input 2: County Name Field
        ...
        county_field.parameterDependencies = [state_counties_fc.name]
        ...
        # Input 10: POIs
        poi_fc = arcpy.Parameter(
            displayName="Points of Interest (POI) Layer",
            name="poi_fc",
            datatype="DEFeatureClass",
            parameterType="Required",
            direction="Input"
        ...
        return [
            state_counties_fc, county_field, county_names, population_fc,
            cbg_outside_pop, state_roads_fc, county_roads_fc, parcel_fc,
            parcel_field, poi_fc, road_buffer_dist, output_gdb
        ]
    ...
    def execute(self, parameters, messages):
        ...
        try:
            ...
            # Get parameters
            state_counties_fc = parameters[0].valueAsText
            ...
            output_gdb = parameters[11].valueAsText or arcpy.env.scratchGDB
